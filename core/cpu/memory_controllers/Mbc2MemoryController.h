...
#ifndef STUDYBOY_MBC2MEMORYCONTROLLER_H
#define STUDYBOY_MBC2MEMORYCONTROLLER_H


#include "MemoryController.h"

class Mbc2MemoryController: public MemoryController {
public:
	Mbc2MemoryController(GameBoyCore* core, RomReader* romReader): MemoryController(core, romReader) {}
...
#endif //STUDYBOY_MBC2MEMORYCONTROLLER_H
